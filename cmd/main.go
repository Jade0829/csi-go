...
func init() {
	...
	flag.StringVar(&conf.Endpoint, "endpoint", "unix://tmp/gluesyscsi.sock", "CSI endpoint")
...
func main() {
	klog.Infof("Starting glusys-CSI driver: %v version: %v", conf.DriverName, driverVersion)
